    ...
    return (
      <div className="rounded-2xl border border-accent/20 bg-accent-subtle p-5">
        <div className="text-xs font-semibold text-accent">
          {t("permission.questionFrom", "来自 {{agent}} 的问题", { agent: provider === "codex" ? "Codex" : "Claude" })}
        </div>
        {questions.map((q, qIndex) => (
          <div key={qIndex} className="mt-4">
            ...
            <div className="mt-3">
              ...
              <input
                type="text"
                className="mt-1 w-full rounded-xl border border-ink-900/10 bg-surface px-3 py-2 text-sm text-ink-700 focus:border-info/50 focus-visible:outline-none"
  ...
  return (
    <div className="rounded-2xl border border-accent/20 bg-accent-subtle p-5">
      ...
      <p className="mt-2 text-sm text-ink-700">
        {t("permission.agentWantsToUse", "{{agent}} 请求使用: {{tool}}", {
